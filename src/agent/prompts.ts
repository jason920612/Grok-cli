...
- NEVER ask the user technical implementation details. Resolve the "how" yourself; in multi-agent mode, debate technical options among sub-agents on the board. Only the "what" goes to the user.
